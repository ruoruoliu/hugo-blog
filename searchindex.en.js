var relearn_searchindex = [
  ...
  },
  {
    ...
    "content": "#todo 强化学习调整agent行为模式：retroformer、voyager #todo rlvr， 清华上交paper：提高pass@1的稳定性 #todo 田渊栋：latent reasoning coconut / attention sync / streaming llm #todo thinking machine lab: tinker api / 自己搭megatron、deepspeed #todo PRM #todo interleaving thinking后训练 #todo verl slime #todo Search-R1",
    "description": "#todo 强化学习调整agent行为模式：retroformer、voyager #todo rlvr， 清华上交paper：提高pass@1的稳定性 #todo 田渊栋：latent reasoning coconut / attention sync / streaming llm #todo thinking machine lab: tinker api / 自己搭megatron、deepspeed #todo PRM #todo interleaving thinking后训练 #todo verl slime #todo Search-R1",
    "tags": [
      "技术笔记"
    ],
    "title": "LLM和agent的训练",
  ...
  },
  {
    ...
    "content": "总结 跟进大模型强化学习进展 搭建商品收货记录系统 大模型强化学习进展跟进 跟进大模型强化学习进展： LLM和agent的训练 [!tip] 知识 待办 强化学习基础知识 AlphaGo技术调研和实践",
    "description": "总结 跟进大模型强化学习进展 搭建商品收货记录系统 大模型强化学习进展跟进 跟进大模型强化学习进展： LLM和agent的训练 [!tip] 知识 待办 强化学习基础知识 AlphaGo技术调研和实践",
    "tags": [
      "周记"
    ],
